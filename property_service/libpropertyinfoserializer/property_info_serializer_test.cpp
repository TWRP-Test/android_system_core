...
TEST(propertyinfoserializer, RealProperties) {
  ...
  auto properties_and_contexts = std::vector<std::pair<std::string, std::string>>{
      ...
      {"init.svc.zygote32", "u:object_r:default_prop:s0"},
      {"init.svc.zygote64", "u:object_r:default_prop:s0"},
      {"init.svc.zygote64_32", "u:object_r:default_prop:s0"},
      ...
      {"ro.boottime.zygote32", "u:object_r:boottime_prop:s0"},
      {"ro.boottime.zygote64", "u:object_r:boottime_prop:s0"},
      {"ro.boottime.zygote64_32", "u:object_r:boottime_prop:s0"},
